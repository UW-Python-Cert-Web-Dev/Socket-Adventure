...
class Server(object):
    ...
    * self.room: one of 0, 1, 2, 3. This signifies which "room" the client is in,
    ...
    def room_description(self, room_number):
        ...
        try:
            result = [
                "This room has brown wallpaper",
                "This room has a green floor",
                "This room has blue walls",
                "This room has a blue floor"
            ][room_number]
        except IndexError:  # Handle bad input
            result = "You are floating in limbo, sorry"
    ...
    def push_output(self):
        ...
        self.client_connection.sendall(self.output_buffer.encode())
